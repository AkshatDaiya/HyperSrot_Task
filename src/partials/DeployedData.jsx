...
function DeployedData({ data, updateModal, setUpdateModal, selectedItemIndex, setSelectedItemIndex, setMessage, handleDelete, filteredData }) {
    return (
        <div className="deployedData">
